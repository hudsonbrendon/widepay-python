...
class WidePay(object):
    ...
    def gerar_carne(self, cliente, pessoa, itens, vencimento, parcelas, dividir,
                    cpf=None, cnpj=None, email=None, telefone=None, endereco=None,
                    referencia=None, notificacao=None, enviar=None, mensagem=None, marketplace=None, boleto=None):
        """
